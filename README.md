# Awesome WebGL [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 449,988 | 🐛 87 | 📅 2026-03-09 with stars
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 3,961 | 🐛 4 | 🌐 C++ | 📅 2026-03-30 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
...
* [WebGL 2 Examples](https://github.com/tsherif/webgl2examples) ⭐ 575 | 🐛 2 | 🌐 HTML | 📅 2018-11-13 - Rendering algorithms implemented in raw WebGL 2.
...
> [More detailed information about the different libraries can be found in the Libraries directory.](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries) ⭐ 1,482 | 🐛 4 | 📅 2026-03-23

### 2D

* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,232 | 🐛 32 | 🌐 TypeScript | 📅 2026-02-10 - 2D physics engine for cross-platform HTML5 game development.
...
* [Phenomenon](https://github.com/vaneenige/phenomenon) ⭐ 1,831 | 🐛 3 | 🌐 TypeScript | 📅 2023-11-10 - Very small, low-level WebGL library that provides the essentials to deliver a high performance experience.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 4,931 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 449,988 | 🐛 87 | 📅 2026-03-09 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 16,362 | 🐛 3 | 🌐 Markdown | 📅 2026-03-26 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,691 | 🐛 296 | 🌐 HTML | 📅 2026-03-16 - Runtime 3D Asset Delivery designed for the web.
* [awesome-vulkan](https://github.com/vinjn/awesome-vulkan) ⭐ 3,664 | 🐛 4 | 📅 2024-06-21 - Curated list of awesome Vulkan projects and ecosystem.
...
Please see [CONTRIBUTING](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) ⭐ 1,482 | 🐛 4 | 📅 2026-03-23 for details.
