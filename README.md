# Awesome WebGL [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 452,326 | 🐛 60 | 📅 2026-04-02 with stars
...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,814 | 🐛 234 | 🌐 HTML | 📅 2026-03-11 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 3,966 | 🐛 7 | 🌐 C++ | 📅 2026-04-06 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
...
* [Khronos Dev Tools](https://github.com/KhronosGroup/WebGLDeveloperTools) ⭐ 214 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-20 - Useful WebGL developer tools, intended to be used as an ES6 module.
...
> [More detailed information about the different libraries can be found in the Libraries directory.](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries) ⭐ 1,483 | 🐛 4 | 📅 2026-04-02
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 452,326 | 🐛 60 | 📅 2026-04-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 16,401 | 🐛 4 | 🌐 Markdown | 📅 2026-03-30 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,696 | 🐛 296 | 🌐 HTML | 📅 2026-03-30 - Runtime 3D Asset Delivery designed for the web.
...
Please see [CONTRIBUTING](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) ⭐ 1,483 | 🐛 4 | 📅 2026-04-02 for details.
