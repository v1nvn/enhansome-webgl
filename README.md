# Awesome WebGL [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 473,589 | 🐛 83 | 📅 2026-06-02 with stars
...
* [WebGL Month](https://github.com/lesnitsky/webgl-month) ⭐ 227 | 🐛 4 | 🌐 JavaScript | 📅 2024-08-28 – Daily WebGL tutorial for a month.
...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,830 | 🐛 235 | 🌐 HTML | 📅 2026-04-29 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,015 | 🐛 8 | 🌐 C++ | 📅 2026-06-07 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,830 | 🐛 235 | 🌐 HTML | 📅 2026-04-29 - Source code to both view and contribute.
...
* [Khronos Dev Tools](https://github.com/KhronosGroup/WebGLDeveloperTools) ⭐ 218 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-20 - Useful WebGL developer tools, intended to be used as an ES6 module.
...
* [Webgl Insight](https://github.com/3Dparallax/insight) ⭐ 914 | 🐛 22 | 🌐 JavaScript | 📅 2021-09-30 - Chrome extension WebGL debugging toolkit providing a variety of capabilities.
* [GLSL Shader Editor Extension](https://github.com/spite/ShaderEditorExtension) ⭐ 633 | 🐛 12 | 🌐 JavaScript | 📅 2017-05-01 - Chrome DevTools extension to help you edit shaders live in the browser.
...
* [WebGL 2 & GLSL Primer: A Zero-to-Hero, Spaced-Repetition Guide](https://github.com/GregStanton/webgl2-glsl-primer) ⭐ 66 | 🐛 0 | 📅 2026-06-04 - Grok WebGL2 and GLSL through a sequence of guided lessons, each chunked into atomic Q\&A cards, with hands-on projects and solution code integrated throughout.
...
> [More detailed information about the different libraries can be found in the Libraries directory.](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries) ⭐ 1,506 | 🐛 7 | 📅 2026-04-02

### 2D

* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,247 | 🐛 31 | 🌐 TypeScript | 📅 2026-04-07 - 2D physics engine for cross-platform HTML5 game development.
* [p2.js](https://github.com/schteppe/p2.js) ⭐ 2,695 | 🐛 106 | 🌐 JavaScript | 📅 2022-07-09 - 2D rigid body physics engine written in JavaScript.
* [Stage.js](https://github.com/shakiba/stage.js) ⭐ 2,557 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-07 - 2D Library for cross-platform HTML5 game development.
...
* [Phenomenon](https://github.com/vaneenige/phenomenon) ⭐ 1,835 | 🐛 3 | 🌐 TypeScript | 📅 2023-11-10 - Very small, low-level WebGL library that provides the essentials to deliver a high performance experience.
...
* [MapMetrics GL](https://github.com/MapMetrics/mapmetrics-gl) ⭐ 0 | 🐛 1 | 🌐 TypeScript | 📅 2026-03-23 - Mapbox GL JS-compatible mapping library with built-in vector tiles, geocoding, routing, and search.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 661 | 🐛 10 | 🌐 JavaScript | 📅 2026-06-01 - WebGL rendering engine for 3D games.
...
* [A-Frame](https://aframe.io/) - Web framework for building virtual reality experiences.
  * [Awesome-AFrame](https://github.com/aframevr/awesome-aframe) ⭐ 1,337 | 🐛 0 | 📅 2017-10-29
* [Primrose](https://github.com/capnmidnight/Primrose/) ⭐ 535 | 🐛 9 | 🌐 JavaScript | 📅 2025-02-11 - Rapidly prototype VR applications in your browser.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 4,975 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 473,589 | 🐛 83 | 📅 2026-06-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 16,785 | 🐛 8 | 🌐 Markdown | 📅 2026-04-09 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,745 | 🐛 318 | 🌐 HTML | 📅 2026-06-01 - Runtime 3D Asset Delivery designed for the web.
* [awesome-vulkan](https://github.com/vinjn/awesome-vulkan) ⭐ 3,686 | 🐛 3 | 📅 2026-05-11 - Curated list of awesome Vulkan projects and ecosystem.
* [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,412 | 🐛 0 | 📅 2026-01-09 - Curated list of awesome OpenGL libraries, debuggers and resources. Inspired by awesome-... stuff.
* [graphics-resources](https://github.com/mattdesl/graphics-resources) ⭐ 1,852 | 🐛 5 | 📅 2020-12-30 - List of graphic programming resources.

## Contributing

Please see [CONTRIBUTING](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) ⭐ 1,506 | 🐛 7 | 📅 2026-04-02 for details.

## Testing

Travis CI testing automation thanks to [awesome\_bot](https://github.com/dkhamsing/awesome_bot) ⭐ 891 | 🐛 11 | 🌐 Ruby | 📅 2023-04-20!
